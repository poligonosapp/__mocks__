...
import PoligonosApp, {LatLngsBoundsReturnType, PropsUser} from "../src/PoligonosApp";


export function getMockGeoJSONLatLngBounds(geojson?: PropsUser["geojson"]) FC<PropsUser["geojson"]> {
  ...
  try {
    ...
    if (geojson) {
      geojson = PoligonosApp().L.geojson.toGeoJSON(geojson);
      // geojson.addEventListener(this);
      return geojson;
    }
